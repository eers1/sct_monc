...
cloud_bounds_heights = cfl.cloud_bounds_heights(ds) 
...
np.savetxt(f'lwp_mask_csvs/{run_name}_inv_height.csv', cloud_bounds_heights, delimiter=',')
np.savetxt(f'lwp_mask_csvs/{run_name}_inv_height_deltheta.csv', deltheta_thresh_heights, delimiter=',')
np.savetxt(f'lwp_mask_csvs/{run_name}_times_mid.csv', ds.time_mid.values, delimiter=',')
